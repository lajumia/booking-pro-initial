...
class Booking_Pro_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->booking_pro, BOOKING_PRO_PATH . 'public/css/booking-pro-public.css', array(), $this->get_booking_pro_version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->booking_pro, BOOKING_PRO_PATH . 'public/js/booking-pro-public.js', array( 'jquery' ), $this->booking_pro_version, false );
